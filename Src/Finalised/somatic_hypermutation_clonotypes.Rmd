---
title: "somatic_hypermutation_clonotypes"
...
Data
```{r}
all_sanger_data <- read.csv("~/Documents/Sequencing/HW_malaria_5002_3001_2008_1010/clonotypes/clonotypes_with_5013.tsv", sep = "\t", header = TRUE, stringsAsFactors = FALSE)
...
Plotting somatic hypermutation between between different V genes
```{r}
library(dplyr)
library(tidyr)
...
# Save the plot
ggsave("~/Documents/Sequencing/Somatic_hypermutation/V_SHM_boxplot_clonotypes.png", width = 8, height = 6, dpi = 300)
```